...
namespace SatisfactorySaveParser.Tests.PropertyTypes
{
    ...
    public class TextPropertyTests
    {
        ...
        private static readonly byte Alt2TextFormatUnknown1 = 4;
        private static readonly byte Alt2TextFormatUnknown2 = 18;
        private static readonly string Alt2TextFormatData = "Base";
        ...
        private const int NoneTextUnknown5 = 255;
        private const int NoneTextUnknown4 = 18;
        ...
        public void TextPropertyAlt2Read()
        {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                Assert.AreEqual(Alt2TextFormatUnknown1, formatData.Unknown1);
                Assert.AreEqual(Alt2TextFormatUnknown2, formatData.Unknown2);
                Assert.AreEqual(Alt2TextFormatData, formatData.Data);
        ...
        public void TextPropertyNoneRead()
        {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                Assert.AreEqual(NoneTextUnknown4, prop.Unknown4);
                Assert.AreEqual(NoneTextUnknown5, prop.Unknown5);
