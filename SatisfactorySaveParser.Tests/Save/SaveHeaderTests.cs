...
namespace SatisfactorySaveParser.Tests.Save
{
    ...
    public class SaveHeaderTests
    {
        ...
        private const FSaveCustomVersion SaveHeaderV5SaveVersion = FSaveCustomVersion.DROPPED_RenamedSaveSessionId;
        ...
        private const FSaveCustomVersion SaveHeaderV4SaveVersion = FSaveCustomVersion.DROPPED_WireSpanFromConnnectionComponents;
