...
namespace SatisfactorySaveParser.Tests.PropertyTypes
{
    ...
    public class ObjectPropertyTests
    {
        ...
        private const string ObjectName = "mOwnedPawn";
        private static readonly ObjectReference ObjectValue = new ObjectReference("Persistent_Level", "Persistent_Level:PersistentLevel.Char_Player_C_0");
        ...
        public void ObjectPropertyRead()
        {
            ...
            var prop = SatisfactorySaveSerializer.DeserializeProperty(reader, BuildVersion) as ObjectProperty;
