...
namespace SatisfactorySaveParser.Tests.PropertyTypes
{
    ...
    public class ArrayPropertyTests
    {
        ...
        //private const float ObjectArrayValue = 141.302673339844f;
        ...
        public void ArrayPropertyObjectRead()
        {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                for (int i = 0; i < 10; i++)
                    Assert.AreEqual(new ObjectReference("Persistent_Level", $"Persistent_Level:PersistentLevel.BP_PlayerState_C_0.FGRecipeShortcut_{i}"), prop.Elements[i]);
