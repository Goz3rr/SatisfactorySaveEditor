...
namespace SatisfactorySaveParser.Tests.PropertyTypes
{
    ...
    public class TextPropertyTests
    {
        ...
        private const ETextFlag TextFlags = (ETextFlag)2;
        ...
        private const ETextFlag AltTextFlags = (ETextFlag)8;
        ...
        private const ETextFlag Alt2TextFlags = (ETextFlag)1;
        ...
        private static readonly ArgumentFormat Alt2ArgumentFormat = new ArgumentFormat()
        {
            ...
            Value = new BaseTextEntry((ETextFlag)18)
            {
                Namespace = "",
                Key = "",
                Value = "Base"
        ...
        private const ETextFlag Alt2TextSourceFlags = (ETextFlag)8;
        ...
        private const ETextFlag NoneTextFlags = (ETextFlag)18;
        ...
        public void TextPropertyRead()
        {
            ...
            var prop = SatisfactorySaveSerializer.DeserializeProperty(reader, BuildVersion) as TextProperty;
